...
<?php echo validation_errors('<div class="error"><span class="label label-important">', '</span></div>'); echo '<br/>'; ?>
		<fieldset>
				...
				<input placeholder="Ingresa el titulo aquí"   name="titulo" value="<?php echo set_value('titulo'); ?>" type="text" id="idtitulo" class="span5 focus">
				<br/>
				...
				<input name="etiquetas" value="<?php echo set_value('etiquetas'); ?>" type="text" class="span5" placeholder="Inserta las etiquetas aquí...">
